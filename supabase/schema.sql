...
-- 시드 데이터: K-ESG 가이드라인 기준 S(사회) 지표 22개 전체 (CLAUDE.md 2절)
...
insert into indicators (name, code, category, definition, department, sort_order) values
  ...
  ('여성 구성원 비율', 'S-3-1', '다양성 및 양성평등', '전체 대비 여성 비율 vs 미등기임원 대비 여성 비율 격차', '인사(HR)', 8),
  ('여성 급여 비율', 'S-3-2', '다양성 및 양성평등', '조직 1인 평균 급여 대비 여성(또는 남성) 1인 평균 급여', '인사(HR)/재무', 9),
  ('장애인 고용률', 'S-3-3', '다양성 및 양성평등', '장애인 상시근로자 수 / 전체 상시근로자 수, 의무고용률 대비', '인사(HR)', 10),
  ('안전보건 추진체계', 'S-4-1', '산업안전', '안전보건 경영방침 및 조직·인력 운영 현황 (안전보건관리책임자 선임 등)', '안전보건팀', 11),
  ('산업재해율', 'S-4-2', '산업안전', '산업재해 발생 건수 기준 재해율, 업종 평균 대비 추세', '안전보건팀', 12),
  ('안전정책 수립', 'S-5-1', '인권', '인권 경영방침 수립 및 공식화 여부, 이사회/경영진 승인 현황', '컴플라이언스팀', 13),
  ('인권 리스크 평가', 'S-5-2', '인권', '인권 영향평가 실시 여부 및 개선조치 이행 현황', '컴플라이언스팀', 14),
  ('협력사 ESG 경영', 'S-6-1', '동반성장', '협력사 대상 ESG 평가·관리체계 운영 현황', '구매팀', 15),
  ('협력사 ESG 지원', 'S-6-2', '동반성장', '협력사 대상 ESG 교육·컨설팅·자금 지원 실적', '구매팀', 16),
  ('협력사 ESG 협약사항', 'S-6-3', '동반성장', '협력사와의 계약서 내 ESG 준수 조항 반영 비율', '구매팀', 17),
  ('전략적 사회공헌', 'S-7-1', '지역사회', '중장기 사회공헌 전략 수립 및 핵심 프로그램 운영 현황', '사회공헌팀', 18),
  ('구성원 봉사참여', 'S-7-2', '지역사회', '임직원 자원봉사 참여율 및 1인당 봉사시간', '사회공헌팀', 19),
  ('정보보호 시스템 구축', 'S-8-1', '정보보호', '정보보호 관리체계(ISMS 등) 구축·인증 현황', '정보보안팀', 20),
  ('개인정보 침해 및 구제', 'S-8-2', '정보보호', '개인정보 침해사고 건수 및 피해구제 조치 현황', '정보보안팀', 21),
  ('사회 법/규제 위반', 'S-9-1', '법/규제위반', '사회 부문 법령 위반 및 제재 건수·금액 현황', '법무팀', 22);
